...
if __name__ == '__main__':
    ...
    span_data, span_size, wmap, cmap, bmap = \
        load_data('data/reddit_2017.txt', 'data/metadata.pkl')

    We = cPickle.load(open('data/gloveReddit.we', 'rb')).astype('float32')
    ...
    for epoch in range(n_epochs):
        ...
        for book, chars, curr, cm, ids in span_data:
        ...
        if cost < min_cost:
            ...
            for book, chars, curr, cm, ids in span_data:
                ...
                for ind in range(len(traj)):
                    ...
                    traj_writer.writerow([bname, c1,  ids[ind]] +  list(step) )   
